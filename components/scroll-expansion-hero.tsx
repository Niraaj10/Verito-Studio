...
//       setIsMobileState(window.innerWidth < 768);a
//     };
...
//               <p
//                 className="mx-auto mt-8 max-w-4xl text-center text-lg font-semibold">
...
//               >
//                 <motion.h2
//                   className='text-4xl md:text-5xl lg:text-4xl -mb-3 font-bold text-center text-[#012cfa] transition-none'
//                   style={{ transform: `translateX(${textTranslateX}vw)` }}
//                 >
//                   {restOfTitle}
//                 </motion.h2>
//                 <motion.h2
//                   className={`${sans.className} text-4xl md:text-5xl lg:text-8xl  text-black transition-none uppercase`}
//                   style={{ transform: `translateX(-${textTranslateX}vw)` }}
//                 >
//                   {firstWord}
//                 </motion.h2>
